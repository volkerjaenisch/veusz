...
setup(name='veusz',
      ...
      data_files=[ ('', ['VERSION']),
                     findData('dialogs', ('ui',)),
                     findData('formats/csv', ('ui',)),
                     findData('formats/data2d', ('ui',)),
                     findData('formats/fits', ('ui',)),
                     findData('formats/hdf5', ('ui',)),
                     findData('formats/simple_plugins', ('ui',)),
      ...
      packages=[ 'veusz',
                   ...
                   'veusz.formats',
                   'veusz.formats.csv',
                   'veusz.formats.data2d',
                   'veusz.formats.fits',
                   'veusz.formats.hdf5',
                   'veusz.formats.simple_plugins',
